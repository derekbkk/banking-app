...
// Don't use (overrides and can use only 1)
logo.className = 'derek';
...
'height/width viewport',
 ...
 Scrolling
window.scrollTo(s1coordinates.left + window.scrollX,
 s1coordinates.top + window.scrollY
 );
